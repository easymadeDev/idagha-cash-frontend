        ...
        <div className="container" style={{ minHeight: '70vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ textAlign: 'center', maxWidth: 500, padding: '40px 0' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '0.83rem', color: 'var(--text-3)', lineHeight: 1.7, margin: '0 0 12px' }}>
                To receive WhatsApp notifications from IDAGHA Alumni, follow these steps:
              </p>

              {/* Steps */}
              {[
                { n: '1', text: 'Tap the green button below — WhatsApp will open automatically.' },
                { n: '2', text: <>The message <strong style={{ color: '#25d366' }}>"join write-personal"</strong> will already be typed for you.</> },
                { n: '3', text: 'Just tap the Send button (▶) in WhatsApp — that\'s all!' },
                { n: '4', text: 'You will receive a confirmation reply and start getting notifications.' },
              ].map(({ n, text }) => (
              ...
              <div style={{ margin: '14px 0 14px', padding: '10px 14px', background: 'rgba(37,211,102,0.08)', borderRadius: 8, fontSize: '0.78rem', color: '#4ade80', fontWeight: 600, textAlign: 'center', letterSpacing: '0.02em' }}>
                ⚡ One send = subscribed forever
              </div>
